...
console.log(str);return'';};exports={version:'0.0.2',build:function(str){return trim(build(parser.parse(str)));},UnsupportedError:UnsupportedError};if(typeof module==='undefined'){this.Js2coffee=exports;}else{module.exports=exports;}}).call(this);