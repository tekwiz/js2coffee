...
return __indexOf.call(trim(str), "\n") >= 0;
};
...
(function() {
var Builders, Code, Node, Transformers, Typenames, Types, UnsupportedError, blockTrim, body, build, buildCoffee, exports, isSingleLine, ltrim, narcissus, p, paren, parser, re, rtrim, strEscape, strRepeat, transform, trim, unreserve, unshift, _, _ref, _ref2;
...
'==': function() {
if (this.right().isA('null', 'void')) {
this.type = Typenames['existential'];
