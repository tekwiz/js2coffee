...
return paren(re('object_init', this.expression, {
brackets: true
})) + "\n";
} else {
...
'.': function() {
var isPrototype, isThis;
isThis = this.left().typeName() === 'this';
isPrototype = this.right().typeName() === 'identifier' && this.right().value === 'prototype';
if (isThis && isPrototype) {
return "@::";
} else if (isThis) {
