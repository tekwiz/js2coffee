...
(function() {
var Builders, Code, Node, Transformers, Typenames, Types, UnsupportedError, blockTrim, body, build, buildCoffee, exports, isSingleLine, ltrim, narcissus, p, paren, parser, re, rtrim, strEscape, strRepeat, tokens, transform, trim, unreserve, unshift, _;
...
return walk(node, node.elsePart, fn);
};
return walk(null, this.body, function(parent, node) {
