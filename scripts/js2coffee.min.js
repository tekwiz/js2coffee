...
(function() {
var Code, blockTrim, exports, isSingleLine, ltrim, p, paren, rtrim, strEscape, strRepeat, trim, unParen, unreserve, unshift;
Code = (function() {
function Code() {
this.code = '';
}
...
unParen = function(string) {
while (string.substr(0, 1) === '(' && string.substr(-1) === ')') {
...
(function() {
var Builder, Code, Node, Transformer, Typenames, Types, UnsupportedError, blockTrim, buildCoffee, exports, isSingleLine, ltrim, p, paren, parser, rtrim, strEscape, strRepeat, trim, unParen, unreserve, unshift, _, _ref, _ref2;
...
return strEscape(n.value).replace(/#\{/g, '#\\{');
};
